...
How can I enable SAML App for a group of users in G-Suite using Organization?
---------------------------------------------------------------------------
...
.. |g-suite-admin-users| image:: support_center_openvpn_gateway_media/g-suite-admin-console-users.png
   :scale: 70%

.. |add-new-user-button| image:: support_center_openvpn_gateway_media/add-new-user-button.png
   :scale: 70%

.. |add-new-user| image:: support_center_openvpn_gateway_media/add-new-user.png
   :scale: 70%

.. |new-user-added| image:: support_center_openvpn_gateway_media/new-user-added.png
   :scale: 70%

.. |g-suite-admin| image:: support_center_openvpn_gateway_media/g-suite-admin-console.png
   :scale: 70%

.. |manage-org| image:: support_center_openvpn_gateway_media/organization-management.png
   :scale: 70%

.. |create-org| image:: support_center_openvpn_gateway_media/create-organization.png
   :scale: 70%

.. |saml-access-org| image:: support_center_openvpn_gateway_media/saml-access-org.png
   :scale: 70%

.. |saml-vpn-apps| image:: support_center_openvpn_gateway_media/saml-vpn-apps.png
   :scale: 70%

.. |g-suite-admin-apps| image:: support_center_openvpn_gateway_media/g-suite-admin-console-apps.png
   :scale: 70%

.. |apps-settings| image:: support_center_openvpn_gateway_media/apps-settings.png
   :scale: 70%

.. |open-SAMLVPN| image:: support_center_openvpn_gateway_media/open-SAMLVPN.png
   :scale: 70%

.. |disable-SAMLVPN-rootorg| image:: support_center_openvpn_gateway_media/disable-SAMLVPN-rootorg.png
   :scale: 70%

.. |enable-SAMLVPN-suborg| image:: support_center_openvpn_gateway_media/enable-SAMLVPN-suborg.png
   :scale: 70%

.. |change-org-button| image:: support_center_openvpn_gateway_media/change-org-button.png
   :scale: 70%

.. |change-org-unit| image:: support_center_openvpn_gateway_media/change-org-unit.png
   :scale: 70%

.. |confirm-org-change| image:: support_center_openvpn_gateway_media/confirm-org-change.png
   :scale: 70%

.. |select-dan-smith| image:: support_center_openvpn_gateway_media/select-dan-smith.png
   :scale: 70%

.. |reopen-2-confirm-org| image:: support_center_openvpn_gateway_media/reopen-2-confirm-org.png
   :scale: 70%
