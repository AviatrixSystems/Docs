...
-------------------
**RFC1918 route propagation from TGW to on-premise networks affecting 4.0 releases prior to 4.0.590 for TGW Hybrid Connection**
...
Description:
Aviatrix transit gateways use BGP to summarize and propagate the network routes. Due to an unexpected software change, software releases from 4.0.368 to 4.0.589 are affected and will forward the RFC1918 routes to VGW. This issue has been addressed in 4.0.590 and all customers who have deployed TGW are advised to upgrade to 4.0.590 or later, immediately. 
