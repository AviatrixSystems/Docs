...
Field Notice 0038 (2022/08/08)
------------------------------

**High Priority Bug Fix: AVX-25385**

ActiveMesh 1.0 is now deprecated. You can upgrade to ActiveMesh 2.0 using the Controller's Migrate option.
