...
- **Enhancement to Gateway Syslog Download** allows you to a gateway syslog directly from the Gateway page. `API support only <https://api.aviatrix.com/?version=latest#8c0f26e3-044d-46e9-b7e7-14cf7ba16a71>`_
