...
#. If have more than 50 Gateways running on your Controller, we strongly recommend that you increase the disk size to at least 64GB before you start the upgrade process. If you have more than 100 Gateways, please have the Controller's disk to be at least 128GB. Please open a support ticket on `Aviatrix Support Portal <https://support.aviatrix.com>`_, if you have any questions or need any assistance.
