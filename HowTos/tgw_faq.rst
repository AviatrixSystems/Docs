...
Security Domain is an abstraction that builds upon AWS Route Domain concept. One or more Spoke VPCs are members in  
a security domain.
...
One analogy to think of a Security Domain is datacenter VLANs and hosts connecting to the VLAN. 
