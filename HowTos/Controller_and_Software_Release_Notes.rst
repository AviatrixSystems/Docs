...
**Network Security Scanner** – The Security Scanner enables you to detect vulnerabilities that an attacker could potentially exploit within your Aviatrix-managed VPCs/VNets. 
