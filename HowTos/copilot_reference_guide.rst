...
You can click the New Topology Experience toggle to see a new version of the map introduced in CoPilot release 3.0.2 (Topology V2). See `Topology Map Version 2 Layout`_ for a description of what constructs are shown on the 5 rings of the Topology V2 map.
...
.. important::
  ...
  * The CostIQ feature requires that your Controller use software version 6.7 or later. 
...
You access CostIQ in CoPilot by going to Home > Billing & Cost > CostIQ or typing CostIQ in the navigation search. If you see a message on the CostIQ page that you require the Aviatrix universal subscription, see `Enabling the CostIQ Feature`_ for information on how to enable the feature.
...
The CostIQ feature requires the **Aviatrix Secure Networking Platform 2208-Universal 24x7 Support** subscription offer license to be enabled. If you see a message on the CostIQ page (CostIQ Home > Billing & Cost > CostIQ) that you require the Aviatrix universal subscription, you must subscribe to and accept terms for this offer in the CSP marketplace before you can enable CostIQ.
...
To enable the CostIQ feature, use the following steps:
...
.. |aviatrix-billing-overview-tab| image:: copilot_reference_guide_media/aviatrix-billing-overview-tab.png
   :scale: 70%
