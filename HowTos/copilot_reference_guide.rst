...
You access CostIQ in CoPilot by going to Home > Billing & Cost > CostIQ or typing CostIQ in the navigation search. If you see a message on the CostIQ page that you require the Aviatrix universal subscription, see `Enabling the CostIQ Feature`_.
