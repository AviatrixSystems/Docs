...
CostIQ offers visibility into costs of resources across all clouds in your multi-cloud network that are managed by Aviatrix Controller. Costs are reported as percentages of traffic generated by end instances in spoke VPC/VNets. 

In CostIQ, you create:

-   Cost centers which are constructs defined by a set of VPC/VNets. The VPC/VNets are those that contain resources used by your real life cost centers or business units. CoPilot looks at the traffic generated by all end instances in the VPC/VNets and calculates the percentage of traffic they generate when compared to the total traffic for all end instances in all VPC/VNets in your Aviatrix managed environment. 

-   Shared services which are constructs defined by the IP addresses or CIDR ranges of resources in your network shared by multiple departments, such as an S3 bucket share by more than one organization.

The CostIQ overview shows a breakdown of your managed resources by top-cost cost centers.

Cost centers can help you identify the top utilized VPC/VNets for different departments and business units in your enterprise. The information can be used for billing purposes. 
...
Cost comains are defined by a unique set of spoke gateways. 
