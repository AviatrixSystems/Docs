...
This technical note provides a step-by-step tips to troubleshoot Aviatrix FireNet Inspection End to End traffic
...
* Spoke VPC * 2
  ...
  ::
    ...
    Attach VPC 10.60.0.0/16 to CLIENT-SD
    
    Attach VPC 10.61.0.0/16 to SERVER-SD
...
* FireNet VPC * 1
  ...
  ::
    ...
    Attache VPC 10.66.0.0/16 to FIRENET-SD
