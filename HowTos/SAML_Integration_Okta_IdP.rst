...
#. Scroll down to SAML Signing Certificates section, notice that the SHA-2 certificate is Active, click Actions -> View IdP metadata

|image9|

#. A new page opens. Copy this page's URL. This value will be used to configure the Aviatrix SP Endpoint.
