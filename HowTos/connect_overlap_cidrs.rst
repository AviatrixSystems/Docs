...
This step is to configure the gateway to translate the destination IP address 172.16.0.43 to the real private IP address 10.17.7.81 and 192.168.0.43 to 10.17.4.179, before routing happens.
...
the address is translated from 10.17.4.149 to 192.168.0.43.
