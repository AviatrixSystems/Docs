...
# -*- coding: utf-8 -*-
#
# aviatrix_docs documentation build configuration file, created by
# sphinx-quickstart on Sun May 21 18:18:19 2017.
#
...
def setup(app):
    ...
    app.add_javascript('digitalpi-utm-tracker-aviatrix.com.js')
...
htmlhelp_basename = 'aviatrix_docsdoc'
...
latex_documents = [
    (master_doc, 'aviatrix_docs.tex', 'aviatrix\\_docs Home',
     'Aviatrix Systems', 'manual'),
]
